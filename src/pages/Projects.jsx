  ...
  return (
    <section className="max-container">
      ...
      <p className="text-slate-500 mt-2 leading-relaxed">
        Outside of work, I&apos;m always learning and working on new projects to
        stay up to date with new trends and technologies, but these are the ones
        I hold closest to my heart at the moment.
      </p>
